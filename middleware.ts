...
export async function middleware(request: NextRequest) {
  ...
  const isAuthRoute = (request.nextUrl.pathname.startsWith('/login') || request.nextUrl.pathname.startsWith('/crear-cuenta')) && !request.nextUrl.pathname.startsWith('/login/olvide-password')
